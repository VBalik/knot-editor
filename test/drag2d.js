...
// что она НЕ удлиняется (верёвка нерастяжима), что тип узла при аккуратном перетаскивании сохраняется,
...
(async ()=>{ const H=global.__H; window.__noAutoSave=true;
  ...
  out.ok = out.cursorOnRope==='grab' && out.cursorOnCrossing==='pointer' && out.cursorAway==='default'
    ...
    && out.after.moved>20 && out.after.lenDrift<5 && out.after.stretch<1.6
